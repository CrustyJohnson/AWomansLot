...
namespace AWomansLot.AWomansLotCharacterCreation
{
    public class AWomansLotCharacterCreationContent : SandboxCharacterCreationContent

    {

        protected EquipmentElement HeirloomArmor
        {
            get
            {
                return Hero.MainHero.Father.BattleEquipment[6];
            }
        }
        ...
        private void AddHeirloomMenuFather(CharacterCreation characterCreation)
        {
            ...
            // Armor
               creationCategory.AddCategoryOption(new TextObject("A sturdy set of armor."), new List<SkillObject>(), null, 12,
               0, 6, null, new CharacterCreationOnSelect(ArmorOnSelect),
                 new CharacterCreationApplyFinalEffects(ArmorOnApply),
                 new TextObject("Somehow it fits."));
        ...
        {
            CharacterObject.PlayerCharacter.Equipment.AddEquipmentToSlotWithoutAgent(EquipmentIndex.Body, new EquipmentElement(HeirloomArmor));
        }
        ...
        private void ArmorOnSelect(CharacterCreation characterCreation)
        {
            ...
            Equipment equipment = CharacterObject.PlayerCharacter.Equipment.Clone(true);
            equipmentList.Add(equipment);
            equipment.AddEquipmentToSlotWithoutAgent(EquipmentIndex.Body, HeirloomArmor);
            characterCreation.ChangeCharactersEquipment(equipmentList);
            characterCreation.ChangeCharsAnimation(new List<string>()
            {
